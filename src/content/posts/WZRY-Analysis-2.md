...
同一个人可能多次碰到五人人机，直接拿 625 条来算会让重复玩家占更多分量。我给每名玩家只留最早一次遭遇，2,012 人中还剩 254 人能回溯上一局，覆盖率 12.62%。这 254 人上一局 33 胜、221 负，胜率 12.99%。
...
分月、分段以后，上一局胜率仍差 53.88 个百分点。目标组的死亡更多，助攻和 KDA 也低很多，击杀数则很接近。数据库里能看到的上一局表现，与随后碰到完整人机队有很强的关联。当前覆盖了 254 名玩家的连续记录，触发条件仍然未知；历史战绩缺失的 1,758 人也可能改变总体结果。
