...
- AI 指出官方 App 有个 100ms 的心跳包，还帮我写好了 `RTCPeerConnection` 的协商逻辑。我几乎没怎么翻 WebRTC 文档，全是靠“嘴炮”驱动 AI 对齐协议的。
...
- **SWR (Stale-while-revalidate)**：为了解决延迟问题，AI 帮我撸了一套缓存逻辑，从详情页退回列表不会重新加载，且保持焦点位置。
